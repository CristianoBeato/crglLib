...
namespace gl
{
    ...
    /// @brief used to compare each incoming pixel depth value with the depth value present in the depth buffer.
    enum func_t : GLenum
    {
        // Never passes.
        NEVER = GL_NEVER,   
    ...
    enum operation_t : GLenum
    {
        ...
        /// @brief representable unsigned value.
        ...
        /// @brief unsigned value when decrementing a stencil buffer value of zero.
